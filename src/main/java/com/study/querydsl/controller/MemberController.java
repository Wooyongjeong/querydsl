...
public class MemberController {
    ...
    public Page<MemberTeamDto> searchMemberV2(MemberSeachCondition condition, Pageable pageable) {
        return memberRepository.searchPageSimple(condition, pageable);
    }

    @GetMapping("/v3/members")
    public Page<MemberTeamDto> searchMemberV3(MemberSeachCondition condition, Pageable pageable) {
